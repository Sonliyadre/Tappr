...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  handleAddPlayerSocketEvent: function handleAddPlayerSocketEvent(data) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.status === 'login') {
	      return React.createElement(
	        'form',
	        { className: 'login' },
	        React.createElement('input', { className: 'login_Name', type: 'text', onChange: this.handleChange, value: this.state.input }),
	        React.createElement(
	          'button',
	          { className: 'login', onClick: this.handleSubmit },
	          'Play!'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactMultiChildUpdateTypes = keyMirror({
	  ...
	  SET_MARKUP: null,
	  TEXT_CONTENT: null
>>>>>>> 73ab0e276392516f85f722122af268aa83f0a03a
	});
