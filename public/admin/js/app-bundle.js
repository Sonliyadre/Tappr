...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminForm = __webpack_require__(159);
	var CountDown = __webpack_require__(161);
	...
	var App = React.createClass({
	    ...
	    render: function render() {
	        switch (this.state.status) {
	            case "mounted":
	                return React.createElement(AdminForm, { handleSuccessfulAdminLogin: this.handleSuccessfulAdminLogin, handleFailedAdminLogin: this.handleFailedAdminLogin });
	            case "loggedIn":
	    ...
	    handleSuccessfulAdminLogin: function handleSuccessfulAdminLogin(username) {
	        this.setState({
	            admin: { username: username },
	            status: 'loggedIn'
	        });
	    },
	    handleFailedAdminLogin: function handleFailedAdminLogin() {
	        this.setState({
	            admin: { username: null },
	            status: 'mounted'
	        });
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('input', { type: 'password', ref: 'username', placeholder: 'Username' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                ...
	                React.createElement('input', { className: 'button', type: 'button', value: 'LOGIN', onClick: this.handleSubmit })
	            )
	        );
	    }
	});
