	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('input', { type: 'password', ref: 'name', placeholder: 'Username' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                ...
	                React.createElement('input', { className: 'button', type: 'submit', value: 'SEND' })
	            )
	        );
	    }
	});

	ReactDOM.render(React.createElement(AdminForm, null), document.querySelector('#app'));
